...
import br.com.myjetpack.data.local.database.dao.ProductDao_Impl;
    ...
    final SupportSQLiteOpenHelper.Callback _openCallback = new RoomOpenHelper(configuration, new RoomOpenHelper.Delegate(3) {
      ...
      protected RoomOpenHelper.ValidationResult onValidateSchema(SupportSQLiteDatabase _db) {
        ...
        if (! _infoProduct.equals(_existingProduct)) {
          return new RoomOpenHelper.ValidationResult(false, "product(br.com.myjetpack.data.local.database.entity.ProductEntity).\n"
                  + " Expected:\n" + _infoProduct + "\n"
                  + " Found:\n" + _existingProduct);
        }
        ...
        if (! _infoSavedProduct.equals(_existingSavedProduct)) {
          return new RoomOpenHelper.ValidationResult(false, "savedProduct(br.com.myjetpack.data.local.database.entity.SavedProductEntity).\n"
                  + " Expected:\n" + _infoSavedProduct + "\n"
