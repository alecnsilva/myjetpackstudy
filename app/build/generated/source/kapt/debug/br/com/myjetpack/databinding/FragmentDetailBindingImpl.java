...
public class FragmentDetailBindingImpl extends FragmentDetailBinding implements br.com.myjetpack.generated.callback.OnClickListener.Listener {
    ...
    private FragmentDetailBindingImpl(androidx.databinding.DataBindingComponent bindingComponent, View root, Object[] bindings) {
        ...
        setRootTag(root);
        // listeners
        mCallback8 = new br.com.myjetpack.generated.callback.OnClickListener(this, 1);
        invalidateAll();
    }
    ...
    protected boolean onFieldChange(int localFieldId, Object object, int fieldId) {
        switch (localFieldId) {
            case 0 :
                return onChangeViewModelViewLiveDataProductDetailModel((androidx.lifecycle.MutableLiveData<br.com.myjetpack.data.local.ProductModel>) object, fieldId);
        }
        return false;
    }
    private boolean onChangeViewModelViewLiveDataProductDetailModel(androidx.lifecycle.MutableLiveData<br.com.myjetpack.data.local.ProductModel> ViewModelViewLiveDataProductDetailModel, int fieldId) {
        if (fieldId == BR._all) {
            synchronized(this) {
                    mDirtyFlags |= 0x1L;
            }
    ...
    protected void executeBindings() {
        ...
        androidx.lifecycle.MutableLiveData<br.com.myjetpack.data.local.ProductModel> viewModelViewLiveDataProductDetailModel = null;
        br.com.myjetpack.data.local.ProductModel viewModelViewLiveDataProductDetailModelGetValue = null;
        br.com.myjetpack.viewmodel.ProductListViewModel viewModel = mViewModel;
        br.com.myjetpack.viewmodel.ProductListViewModel.ViewLiveData viewModelViewLiveData = null;
